...
contract. Hash-to-point in standard SHAKE-256 remains the dominant term and the true frontier: a
builtin-hash variant is $\sim$50--100$\times$ cheaper but non-interoperable, and a
\texttt{keccak\_f1600} syscall (SNIP-32) would let the interoperable hash fit alongside the looped
NTT.
